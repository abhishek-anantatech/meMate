...
import "./style.css";
import Images from "../../assests/single-page-img";

const Single = () => {
  return (
    <div>
      <div className="parent">
        <div className="accounting-text-A">Accounting</div>
        <div className="heading-1-A">
          Transforming design education for students
        </div>
        <div className="heading-date-A">June 19,2024</div>
        <div className="img-1-container-A">
          <img className="img-1" src={Images.img1}></img>
        </div>
        <div className="heading-2-A single-page-heading">
        ...
        <div className="heading-3-A sub-heading">Entertainment</div>
        <div className="heading-3-text-A single-page-heading-text">
        ...
        <div className="heading-4-A sub-heading">Food</div>
        <div className="heading-4-text-A single-page-heading-text">
          ...
          man’s ability to mix. A real melting pot if I may say so myself. But
          is that all what casino cities like Las Vegas are about? Do you have
          to remain in the city to really and truly enjoy your stay? No.
        </div>
        <div className="comment-container-A">
          <div className="comment-text-A">
          ...
          <div className="comment-name-A">Adrien Belaich</div>
        </div>
        <div className="heading-5-A single-page-heading">
          Microsoft Patch Management For Home Users
        </div>
        <div className="heading-5-text-A single-page-heading-text ">
          Last month, my wife, Anne Doe, took me to Las Vegas because she had to
          go for a business convention. Needless to say, she writes for an guide
          to casinos and I hate gambling. But then, she likes it and this
          supports us too, so I went along without any hassle. At first I was
        ...
        <div className="heading-6-A sub-heading">Entertainment</div>
        <div className="heading-6-text-1-A single-page-heading-text">
          One of the greatest things about Las Vegas, Reno and Atlantic City
          (but especially Las Vegas) is the number of shows that are available.
          You can get to watch top class comedians like Jay Leno, Jerry
          Seinfeld, Ray Romano, Tim Allen and even the likes of Bill Cosby and
        ...
        <div className="img-2-container-A">
          <img className="img-2" src={Images.img4}></img>
        </div>
        <div className="heading-6-text-2-A single-page-heading-text">
          One of the greatest things about Las Vegas, Reno and Atlantic City
          (but especially Las Vegas) is the number of shows that are available.
          You can get to watch top class comedians like Jay Leno, Jerry
          Seinfeld, Ray Romano, Tim Allen and even the likes of Bill Cosby and
