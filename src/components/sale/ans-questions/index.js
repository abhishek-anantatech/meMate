...
const QuestionAnswer = () => {
  ...
  const questions = [
    {
      question:
        "What features does memate offer as a Sales Management Software?",
      key: 0,
    },
    {
      question:
        "How does memate enhance efficiency with its Sales Pipeline Management Tool?",
      key: 1,
    },
    {
      question:
        "What advantages does memate’s CRM Sales Tool offer for Small Businesses?",
      key: 2,
    },
    {
      question:
    ...
    {
      question:
        "How does memate optimise business operations with its Sales Process Optimisation Software?",
      key: 6,
    },
    {
    ...
    {
      question:
        "How can memate’s Sales Funnel for Small Business help in growth?",
      key: 8,
    },
    {
      question:
        "What features does memate include in its Sales Pipeline Software?",
      key: 9,
    },
                ...
                sx={{
                  ...
                  color:
                    selectedQuestion === index
                      ? "linear-gradient(to right, #1AB2FF 33.15%, #FFB258 62%)"
                      : "#000",
                }}
              >
